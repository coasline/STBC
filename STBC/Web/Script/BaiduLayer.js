...
dojo.declare("BaiduLayer", esri.layers.TiledMapServiceLayer, {
    ...
    getTileUrl : function(level, row, col) {
        //var url = "http://mt" + (col % 4) + ".google.cn/vt/v=w2.114&hl=zh-CN&gl=cn&" + "x=" + col + "&" + "y=" + row + "&" + "z=" + level + "&s=";
        var zoom = level - 1;
        ...
        var url = "http://online3.map.bdimg.com/tile/?qt=tile&x=" + numX + "&y=" + numY + "&z=" + zoom + "&styles=pl&udt=20140814";
